...
import { ApiBcraService } from 'src/app/content/service/api-bcra.service';
...
export class InflacionBcraComponent {
    constructor(public layoutService: LayoutService, private messageService: MessageService, private apiBcra: ApiBcraService) {
    ...
    ngOnInit() {
        this.apiBcra.getInflacionInteranual().subscribe(
            (res) => {
                this.apiData = res;
                this.initCharts();
            },
